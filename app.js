...
function headerHTML(aba){
  ...
  var logoSide='<div style="display:flex;align-items:center;padding:8px 14px;border-right:1px solid rgba(255,255,255,.07);flex-shrink:0;"><img src="logo-branco-negativo.png" style="height:54px;object-fit:contain;" onerror="this.style.display=\'none\'"/></div>';
